...
/usr/local/bin/instaloader --sessionfile=/home/pi/.instaloader/session-dawid.gliwka -l dawid.gliwka -s --highlights -F --no-captions --no-metadata-json kiro.jpg monik_nuda lovely.bananassa
